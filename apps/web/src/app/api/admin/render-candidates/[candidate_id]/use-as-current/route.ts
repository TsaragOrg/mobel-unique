...
import { handleUseRenderCandidateRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface RenderCandidateUseAsCurrentRouteContext {
  params: Promise<{
    candidate_id: string;
  }>;
}
