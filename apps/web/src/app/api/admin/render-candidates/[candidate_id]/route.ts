...
import { handleDeleteRenderCandidateRequest } from "../../../../../lib/admin-catalog-route-handlers";
...
interface RenderCandidateRouteContext {
  params: Promise<{
    candidate_id: string;
  }>;
}
