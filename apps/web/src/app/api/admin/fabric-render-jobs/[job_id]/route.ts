...
import { handleGetFabricRenderJobRequest } from "../../../../../lib/admin-catalog-route-handlers";
...
interface FabricRenderJobRouteContext {
  params: Promise<{
    job_id: string;
  }>;
}
