...
import { handlePublishSofaRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface PublishSofaRouteContext {
  params: Promise<{
    sofa_id: string;
  }>;
}
