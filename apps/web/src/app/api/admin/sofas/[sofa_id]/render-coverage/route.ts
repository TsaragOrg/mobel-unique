...
import { handleGetRenderCoverageRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface RenderCoverageRouteContext {
  params: Promise<{
    sofa_id: string;
  }>;
}
