...
import { handleUnpublishSofaRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface UnpublishSofaRouteContext {
  params: Promise<{
    sofa_id: string;
  }>;
}
