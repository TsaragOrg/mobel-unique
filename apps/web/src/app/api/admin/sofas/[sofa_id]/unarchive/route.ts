...
import { handleUnarchiveSofaRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface UnarchiveSofaRouteContext {
  params: Promise<{
    sofa_id: string;
  }>;
}
