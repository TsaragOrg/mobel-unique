...
import { handleArchiveSofaRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface ArchiveSofaRouteContext {
  params: Promise<{
    sofa_id: string;
  }>;
}
