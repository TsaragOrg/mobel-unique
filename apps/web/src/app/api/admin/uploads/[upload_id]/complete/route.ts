...
import { handleCompleteUploadRequest } from "../../../../../../lib/admin-catalog-route-handlers";
...
interface UploadCompleteRouteContext {
  params: Promise<{
    upload_id: string;
  }>;
}
...
export async function POST(
  ...
  try {
    ...
    const { upload_id: uploadId } = await context.params;

    return handleCompleteUploadRequest({
      ...adminInput,
      uploadId,
    });
  } catch {
