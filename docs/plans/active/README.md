...
| PLAN-0099 | SPEC-0010 | active | web | Admin ZIP export production size resilience will raise the private catalog ZIP artifact limit and add an explicit route duration guard for large production exports. |
