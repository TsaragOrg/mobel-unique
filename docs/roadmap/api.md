...
| Active | SPEC-0015 | PLAN-0074 | Public simulation email-verification APIs will delegate OTP request and verification to Supabase Auth, keep Supabase Auth sessions server-side, issue only the application simulation access token, and require verified sessions before job creation. |
