...
| Active | SPEC-0016 | PLAN-0049 | Admin fabric create and edit forms will show browser-side square crop controls for newly selected swatch images and upload the generated square swatch through the existing signed upload flow. |
